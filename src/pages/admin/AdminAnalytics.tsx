...
import { useAnalyticsDashboard, useAnalyticsMetrics, useRevenueStats } from "@/hooks/useApi";
...
export default function AdminAnalytics() {
  ...
  const stats = {
    views: dashboard.page_views || metrics.page_views || "0",
  ...
  // Monthly sales data (from API or fallback)
  const monthlySales = revenueData.monthly || dashboard.monthly_sales || [
    { month: "Oct", value: 0 },
    { month: "Nov", value: 0 },
    { month: "Dec", value: 0 },
    { month: "Jan", value: 0 },
          ...
          <div className="flex items-end gap-2 md:gap-4 h-40">
            {monthlySales.map((m: any) => (
              <div key={m.month} className="flex-1 flex flex-col items-center gap-1">
                <span className="text-xs font-medium">{m.value || 0}</span>
                <div
